...
if __name__ == '__main__':
    ...
    if runType == "single":
        ...
        optimiser = tensorOptimisation(param_args, f'data\\real_data\\*', ROI, num_particles=20, name_prefix="real_group")
        ...
        analyser.print_convergence_results("output\\optimisation_results\\real_group_funcs_7_loo_index", optimiser)

        # analyser.compare_pipelines("output\\optimisation_results\\real_group_funcs_7_loo_index", optimiser)

        history, error = analyser.return_particle_history("output\\optimisation_results\\real_group_funcs_7_loo_index")

        plotter = PlottingFunctions(optimiser)

        # plotter.plot_optimisation_results("output\\optimisation_results\\real_group_funcs_7_loo_index5.pkl", channels=ROI)
